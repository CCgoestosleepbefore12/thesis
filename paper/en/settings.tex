...
% theorem environments (Ch.3 propositions etc.)
\usepackage{amsthm}
...
% multirow tables, algorithms
\usepackage{multirow}
% constrain over-wide tables to the text width (shrinks only if needed)
...
% custom math commands (consistent with the cn/ version)
...
% figure search path
\graphicspath{{graphics/}{graphics/英文版本图片/}}
